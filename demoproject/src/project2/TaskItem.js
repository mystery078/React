	...
	render(){
		return(
			...
			<tr>
				...
				<td className="text-center"><span onClick={this.onUpdateStatus} className={this.props.task.status ? 'label label-success' : 'label label-danger'}>{this.props.task.status ? 'Active' : 'Deactive'}</span></td>
